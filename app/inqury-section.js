    ...
    return (
        ...
        <section className={inquiryStyles.inqurySection}>
            ...
            <div className={`container ${inquiryStyles.inquiryMainContainer} ${inquiryStyles.container}`}>
                <div className="row">
                    <div className={`col-xxl-12 ${inquiryStyles.subContainer}`}>
                        <div className={`col-xxl-6 ${inquiryStyles.subContainerLeft}`}>
                        ...
                        <div className={`col-xxl-6 ${inquiryStyles.subContainerRight}`}>
                            <ContactForm />
                        </div>
                    </div>
                </div>
