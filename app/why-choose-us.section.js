    ...
    return (
        <section>
            ...
            <div className={`container ${whyChooseUsStyles.mainContainer} ${whyChooseUsStyles.container}`}>
                ...
                <div className="row">
                    <div className="col-xxl-12 d-flex p-0 me-1">
                        <div className={`col-xxl-7 ${whyChooseUsStyles.subContainerLeft}`}>
                        ...
                        <div className={`col-xxl-5 ${whyChooseUsStyles.subContainerRight}`}>
